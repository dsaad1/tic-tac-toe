...
namespace FIMSpace.Jiggling
{
    ...
    /// </summary>
    [AddComponentMenu("FImpossible Games/Jiggling/FJiggling Active")]
    public class FJiggling_Active : FJiggling_Base
    {
        ...
        protected override void CalculateJiggle()
        {
            ...
            t.transform.localRotation = initRotation * Quaternion.Euler((val1 + add1) * RotationAxesMultiplier.x, (-val2 - add1) * RotationAxesMultiplier.y, (val2 + add2) * RotationAxesMultiplier.z);
