...
namespace FIMSpace.Jiggling
{
    ...
    /// </summary>
    [AddComponentMenu("FImpossible Games/Jiggling/FJiggling Simple - Bones")]
    public class FJiggling_SimpleBones : FJiggling_Simple
    {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (NoScaleKeyframes) transform.localScale = initialKeyScale;

            // Every beginning of late update rotations are the same as in animation played by Animator component
            initRotation = transform.localRotation;// initialKeyRotation;
